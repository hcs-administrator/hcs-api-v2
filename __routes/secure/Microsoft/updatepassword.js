...
async function connectToAD() {
    ...
    var config = { url: 'ldap://ad.hamiltonchristian.school.nz',
               baseDN: 'dc=ad,dc=hamiltonchristian,dc=school,dc=nz',
               username: 'HCS_AD\administrator',
               password: '(Admin123)**)' }

    var ad = new ActiveDirectory(config);

    const userPrincipalName = 'ethkra52@hamiltonchristian.school.nz';
